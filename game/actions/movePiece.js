...
export const movePiece = (store)=>({piece,newPosition,takenPiece,special,promoteTo,targetRook,rookNewPosition})=>{
    ...
    if (special === Action.CASTLE) {
        movePiece(store)({piece:targetRook,newPosition:rookNewPosition});
    }
